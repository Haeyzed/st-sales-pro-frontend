...
import { brandsColumns as columns } from "./components/brands-columns"
import { getBrands, type BrandFilters } from "./data/brands"
...
export function BrandsTable() {
  ...
  const rawBrands = data?.data || []
  const meta = data?.meta

  // Client-side status filter state
  const [statusFilter, setStatusFilter] = useState<string[]>([])

  // Filter brands client-side by status
  const brands = useMemo(() => {
    let filtered = rawBrands
