...
import { importBrands } from "../data/brands"

type BrandImportDialogProps = {
  open: boolean
...
export function BrandsImportDialog({
  ...
  const handleImport = async () => {
    ...
    setIsLoading(true)
    try {
      const result = await importBrands(files[0])
      toast.success(
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Upload a CSV file to import brands. Make sure the file follows
              the required format.
            </DialogDescription>
          </DialogHeader>
    ...
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>
            Upload a CSV file to import brands. Make sure the file follows the
            required format.
          </DrawerDescription>
        </DrawerHeader>
