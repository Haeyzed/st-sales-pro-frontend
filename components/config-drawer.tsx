...
import { useColor, ACCENT_COLORS } from "@/context/color-provider"
...
export function ConfigDrawer() {
  ...
  const { resetAccentColor } = useColor()
...
function ColorConfig() {
  const { accentColor, setAccentColor, resetAccentColor, defaultAccentColor } =
    useColor()
